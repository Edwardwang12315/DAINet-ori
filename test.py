...
def load_models():
    ...
    net.eval()
    net.load_state_dict(torch.load('../../model/forDAINet/dark/dainet_ori.pth')) # Set the dir of your model weight
...
if __name__ == '__main__':
    ...
    def load_images():
      imglist = glob.glob('../../dataset/ExDark-coco/images/total/*.jpg') # Set the dir of your test data
      return imglist
